...
newDimentions = 1024; % (512, 256, 128 o 64)
newImage = reduce(originalImage,newDimentions);
imshow(newImage); 

% La función recibe como parámetros la imagen original y una 
% variable que almacena la dimension de la nueva imagen reducida.  
